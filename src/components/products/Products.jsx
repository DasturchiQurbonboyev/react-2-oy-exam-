...
const Products = () => {
    ...
    let products = data?.map((el) => (
        <div key={el.id} className="relative m-10 flex w-[230px] max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
            <div className='product '>
                <div className=' flex justify-center items-center p-[15px] '>
                    <img className="object-cover h-[200px]" src={el.thumbnail} alt="product image" />
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <h5 onClick={() => dispatch(toggleSingle(el))} title={el.title} className="line-clamp-1 text-xl tracking-tight text-slate-900"><Link to={"/single"}>{el.title}</Link></h5>
